...
int OnInit() {
    ...
    bool success = orderManager.bookMarketOrder(signal, optimalLotSize, TEST_MAGIC_NUMBER);
...
void OnTimer() {
    ...
    positionOptimizer.CloseOppositePosition(POSITION_TYPE_BUY, s, TEST_MAGIC_NUMBER);
    EventKillTimer();
}
